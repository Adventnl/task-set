/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 052b11d8a432df45e9b7d018ec84b096)
...
interface __BaseEnv_Env {
	...
	TASK_SPACE: DurableObjectNamespace<import("./worker/index").TaskSpace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TaskSpace";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_PASSCODE" | "SESSION_SECRET" | "OPENROUTER_API_KEY">> {}
}
